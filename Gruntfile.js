...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      dev: {
        files: [
          {
            src: ["src/css/default-skin/default-skin.svg"],
            dest: "dist/default-skin/default-skin.svg",
          },
          {
            src: ["src/css/default-skin/default-skin.png"],
            dest: "dist/default-skin/default-skin.png",
          },
          {
            src: ["src/css/default-skin/preloader.gif"],
            dest: "dist/default-skin/preloader.gif",
          },
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-assets/all.min.css": [
            "website/site-assets/site.css",
            "website/dist/photoswipe.css",
          ],
        },
      },
    },
    ...
    svgmin: {
      dist: {
        files: {
          "src/css/default-skin/default-skin.svg":
            "src/css/default-skin/default-skin.svg",
        },
      },
    },
  ...
  grunt.task.registerMultiTask(
    ...
    function () {
      ...
      var uiContents = grunt.file.read(
        basePath + "ui/photoswipe-ui-default.js"
      );
